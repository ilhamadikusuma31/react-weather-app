  ...
  return(
    <div className="flex flex-row justify-center my-6">
      <div className="flex flex-row w-3/4 justify-center items-center space-x-4">
        ...
        />
        <UilSearch size={25} className="text-white cursor-pointer transition hover:scale-125"/>
        <UilLocationPoint size={25} className="text-white cursor-pointer transition hover:scale-125"/>
      </div>
